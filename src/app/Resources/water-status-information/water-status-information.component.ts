...
@Component({
  selector: 'app-water-status-information',
  templateUrl: './water-status-information.component.html',
  styleUrls: ['./water-status-information.component.css']
})

export class WaterStatusInformationComponent implements AfterViewInit {
